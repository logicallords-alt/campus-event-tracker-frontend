...
const SubmitCertificate = () => {
  ...
  useEffect(() => {
    console.log('[Frontend] Fetching event details for submission:', id);
    api.get('/api/events/my-events')
      ...
      .catch((err) => {
        console.error('[Frontend] Fetch Event Error:', err.response?.data || err.message);
      });
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log('[Frontend] Submitting certificate for event:', id);
    ...
    try {
      ...
      console.error('[Frontend] Submission Error:', err.response?.data || err.message);
